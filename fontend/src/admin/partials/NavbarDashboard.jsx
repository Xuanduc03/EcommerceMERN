...
export const NavbarDashboard = () => {
    ...
    // khoi tao trang thai sidebar tu localstore
                ...
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            <button onClick={toggleSidebar} id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar" className="p-2 text-gray-600 rounded cursor-pointer lg:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                {
                                    isOpenSidebar ? (
                            ...
                            <p className='text-xl font-semibold text-gray-900 rounded-lg dark:text-white'>Admin Dashboard</p>
                        ...
                        <div className="flex items-center">
                            ...
                            {/* <!-- Notifications --> */}
                            <button type="button" onClick={toggleNotification} data-dropdown-toggle="notification-dropdown" className="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700">
                            ...
                            {isOpenNotify && (
                                <>
                                    {/* dropdown menu */}
                                    <div className="absolute right-0 top-20 max-w-sm overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700">
                            ...
                            {/* <!-- Apps --> */}
                            <button type="button" onClick={toggleMenu} data-dropdown-toggle="apps-dropdown" className="hidden p-2 text-gray-500 rounded-lg sm:flex hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700">
                                <span className="sr-only">View notifications</span>
                                {/* <!-- Icon --> */}
                            ...
                            {isOpenMenu && (
                                <>
                                    {/* <!-- Dropdown menu --> */}
                                    <div className="absolute right-0 top-20 max-w-sm  overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600">
                                        <div className="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                            Apps
                                        </div>
                            ...
                            <div className="flex items-center ml-3">
                                <div>
                                    <button type="button" onClick={toggleProfile} className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                                ...
                                </div>
                                {
                                    isOpenProfile && (
                                        <>
                                            {/* <!-- Dropdown menu --> */}
                                            <div className="z-50 absolute right-0 top-20 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600">
